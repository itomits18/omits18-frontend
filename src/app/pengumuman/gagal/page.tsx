  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-t from-[#5180BB] via-[#EEE2DF] via-35% to-[#9C3022]">
      ...
      <Image
        ...
        height={247}
        alt="cloud6"
        className="absolute top-[54%] right-0 object-contain opacity-30 md:hidden"
      />
      ...
      <Image
        ...
        height={214}
        alt="cloud7"
        className="absolute top-[62%] object-contain opacity-30 md:hidden"
      />
      ...
      <Image
        ...
        height={205}
        alt="cloud8"
        className="absolute top-[70%] right-0 object-contain opacity-30 md:hidden"
      />
      ...
      <Image
        ...
        height={220}
        alt="cloud9"
        className="absolute top-[74%] object-contain opacity-50 md:hidden"
      />
      ...
      <Image
        ...
        height={151}
        alt="cloud10"
        className="absolute right-0 bottom-0 object-contain opacity-50 md:hidden"
      />
      ...
      <Image
        ...
        height={144}
        alt="logo"
        className="absolute top-[3%] left-1/2 z-10 w-[25vh] -translate-x-1/2 transform object-contain md:w-[30vh]"
      />
      ...
      <Image
        ...
        height={386}
        alt="cloud5"
        className="absolute top-[44%] left-[25%] hidden object-contain opacity-30 md:block"
      />
      ...
      <Image
        ...
        height={386}
        alt="cloud5"
        className="absolute top-[44%] left-[50%] hidden object-contain opacity-30 md:block"
      />
      ...
      <Image
        ...
        height={179}
        alt="cloud5"
        className="absolute top-[54%] left-1/2 hidden -translate-x-1/2 transform object-contain opacity-50 md:block"
      />
      ...
      <Image
        ...
        height={241}
        alt="cloud5"
        className="absolute bottom-0 left-[20%] hidden object-contain opacity-30 md:block"
      />
      ...
      <Image
        ...
        height={172}
        alt="cloud5"
        className="absolute bottom-0 left-[50%] hidden object-contain opacity-50 md:block"
      />
      ...
      <Image
        ...
        height={209}
        alt="cloud5"
        className="absolute right-0 bottom-[20%] hidden object-contain opacity-50 md:block"
      />
      ...
      <Image
        ...
        height={179}
        alt="cloud5"
        className="absolute bottom-[10%] hidden object-contain opacity-30 md:block"
      />
      ...
      <Image
        ...
        height={197}
        alt="cloud5"
        className="absolute bottom-[10%] left-[10%] hidden object-contain opacity-30 md:block"
      />
      ...
      <Image
        ...
        height={199}
        alt="cloud5"
        className="absolute bottom-0 hidden object-contain opacity-80 md:block"
      />
      ...
      <Image
        ...
        height={161}
        alt="cloud5"
        className="absolute bottom-0 left-[10%] hidden object-contain opacity-50 md:block"
      />
      ...
      <Image
        ...
        height={174}
        alt="cloud4"
        className="absolute right-0 bottom-0 hidden object-contain opacity-50 md:block"
      />
      ...
      {/*Frame*/}
      <div className="absolute top-1/2 left-1/2 flex w-full max-w-xs -translate-x-1/2 -translate-y-1/2 transform flex-col items-center rounded-4xl px-4 py-6 md:max-w-xl md:px-12 md:py-12 xl:max-w-2xl 2xl:max-w-4xl">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('/images/semifinal/bg-gagal.png')",
            filter: 'blur(25px)',
            transform: 'scale(1.1)',
          }}
        />
        <div className="z-20">
          ...
          <Typography
            ...
            weight="bold"
            variant="h4"
            className="text-center text-2xl font-bold text-[#9C3022] [text-shadow:_2px_1px_0_rgb(0_0_0_/_90%)] md:text-4xl xl:text-5xl"
          >
            HASIL PENGUMUMAN
          </Typography>
          ...
          <Typography
            ...
            weight="bold"
            variant="h3"
            className="mt-3 px-2 text-center text-sm text-[#5C2921] md:mt-5 md:text-lg"
          >
          ...
          <div className="mt-3 mb-8 flex w-full justify-center space-y-3">
            <div className="grid grid-cols-[auto_auto_1fr] gap-x-2 gap-y-1">
              <Typography
                variant="p"
                className="text-sm font-semibold text-[#5C2921]"
              >
                No Peserta
              </Typography>
              <Typography
