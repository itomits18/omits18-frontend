...
export default function page() {
  return (
    <section className="relative min-h-screen max-w-full bg-gradient-to-b from-purple-300 via-pink-400 via-50% to-yellow-200 max-lg:overflow-hidden lg:min-h-screen xl:min-h-[120vh]">
      <Image
